...
namespace Tests
{
    public class TestHelper
    {
        ...
        public static Checkout.ApiServices.ShoppingList.Models.Item GetShoppingListItem()
        {
            return new Checkout.ApiServices.ShoppingList.Models.Item
            {
                CustomerID = RandomData.UniqueString,
                Name = RandomData.FullName,
                Quantity = 1
            };
        }
