namespace Checkout
{
    public class ApiUrls
    {
        ...
        // Shopping List URIs
        private static string _getShoppingListsUri;
        private static string _createShoppingListUri;
        private static string _updateShoppingListUri;
        private static string _deleteShoppingListUri;
        private static string _getShoppingListByCustomerUri;
        private static string _getShoppingListByProductUri;

        private static string _getProductsUri;
        ...
        public static void ResetApiUrls()
        {
            ...
            // Shopping List URIs
            _getShoppingListsUri = null;
            _createShoppingListUri = null;
            _updateShoppingListUri = null;
            _deleteShoppingListUri = null;
            _getShoppingListByCustomerUri = null;
            _getShoppingListByProductUri = null;
            _getProductsUri = null;
        }
        ...
        // Shopping List
        public static string GetOrDeleteShoppingLists
            => _getShoppingListsUri ??
            (_getShoppingListsUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/{0}"));

        public static string CreateShoppingList
            => _createShoppingListUri ??
            (_createShoppingListUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/Insert/"));

        public static string UpdateShoppingList
            => _updateShoppingListUri ??
            (_updateShoppingListUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/Update/"));

        public static string DeleteShoppingList
            => _deleteShoppingListUri ??
            (_deleteShoppingListUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/Delete/"));

        public static string GetProducts
            => _getProductsUri ??
            (_getProductsUri = string.Concat(AppSettings.BaseApiUri, "/product/{0}"));


        public static string GetShoppingListsForCustomer
            => _getShoppingListByProductUri ??
            (_getShoppingListByProductUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/GetByCustomer?customerId={0}"));
        
        public static string GetShoppingListsByProduct
            => _getShoppingListByCustomerUri ??
            (_getShoppingListByCustomerUri = string.Concat(AppSettings.BaseApiUri, "/shoppinglist/GetByProduct?productId={0}"));
